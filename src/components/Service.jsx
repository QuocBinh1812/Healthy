...
import GarleryItem from "./GarleryItem";
const Service = () => {
      ...
      <div className="myContainer">
        ...
        <div
          className={`flex justify-center mt-[25px] ${
            isMore ? " " : "mb-[28px]"
          } items-center gap-2 flex-wrap max-w-[960px]`}
        >
        ...
        {isMore && (
          <div className="flex justify-center mt-[5px] mb-[28px] items-center gap-2 flex-wrap max-w-[960px]">
            <GarleryItem team={foodPicture["m03.jpg"]} title="05.21.Morning" />
            <GarleryItem team={foodPicture["l03.jpg"]} title="05.21.Morning" />
            <GarleryItem team={foodPicture["d01.jpg"]} title="05.21.Morning" />
            <GarleryItem team={foodPicture["l01.jpg"]} title="05.21.Morning" />
